...
const CreateTask: React.FC <ICreateTaskProps>= ({isOpen,handleClose}): JSX.Element => {
  ...
  const handleCreate = () => {};
  return (
    <div className={` ${isOpen?'block':'hidden'} w-[1153px] relative bg-white shadow-lg rounded rounded-[20px]]`}>
      <div
