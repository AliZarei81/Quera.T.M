...
const Workspace: React.FC<IWorkspaceLayoutProps> = ({ children }) => {
  return (
    <div className="w-[1100px] h-screen ">
      <div className="w-[1360px] h-[768px] top-[64px] left-[-292px] gap-l">
        <div className="w-auto h-[200px] gap-[32px]  pr-[32px] pl-[187px]">
          <h1 className="w-auto h-[32px] font-iran-yekan text-heading-s leading-8 self-start text-gray-darker">
            {children}
          </h1>
          <NewprojectBtn />
        </div>
